-- Migration 092: Inclui day_name e date_label nos slots de rpc_n8n_get_slots
--
-- Problema: a função retornava apenas o timestamp ISO (start/end) e deixava
-- o LLM calcular o nome do dia da semana. O modelo errava sistematicamente
-- (ex: dizia "quarta-feira, 21 de abril" sendo que 21/04 é terça-feira).
--
-- Correção: o banco de dados calcula o nome do dia com EXTRACT(DOW) e o
-- retorna junto com cada slot. O LLM só precisa usar o valor pronto.
      ...
      IF FOUND THEN
        ...
        LOOP
          ...
          IF v_conflicts = 0 THEN
            -- Compute day name in BRT so LLM does not have to guess
