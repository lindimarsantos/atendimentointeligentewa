-- ============================================================
-- Migration 082: Fix rpc_n8n_get_scheduling_followup_targets
--
-- Migration 080 was committed to git but never applied to the DB,
-- so the function still had the old parameter names p_hours_min /
-- p_hours_max while n8n sends p_hours_first / p_hours_second.
-- ============================================================
