-- Migration 045: Add customer_phone to rpc_n8n_get_voice_config
-- The Enviar Voz WhatsApp node needs the customer's phone number.
-- Resolved via messaging.conversations → crm.customers.phone_e164.
